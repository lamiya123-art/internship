...
# 🛠 Instead of dropping based on missing count, keep only the desired columns
required_columns = [
    'country', 'year',
    'cereal_yield', 'fdi_perc_gdp', 'gni_per_cap',
...
# 👀 Check which columns are actually available in your dataset
available_columns = [col for col in required_columns if col in all_vars_clean.columns]
missing_columns = [col for col in required_columns if col not in all_vars_clean.columns]

print("✅ Available columns:", available_columns)
print("❌ Missing columns:", missing_columns)

# 🎯 Keep only the columns you want (and that exist)
all_vars_clean2 = all_vars_clean[available_columns]

# 🧼 Drop rows with any missing values to keep it clean (optional)
all_vars_clean3 = all_vars_clean2.dropna()

print("\n✅ Final dataset shape:", all_vars_clean3.shape)
print("✅ Final columns:", all_vars_clean3.columns.tolist())
